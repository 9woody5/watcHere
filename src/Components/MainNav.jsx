  ...
  return (
    <>
        <div className="navbar flex justify-end h-20 font-pretendard">
          <div className="w-[90%] mx-16 flex justify-end items-center">
            ...
            {isLoggedIn ? (
              ...
              // 비로그인 상태
              <button onClick={handleClick} className="font-pretendard text-white leading-4 w-16 h-8 bg-emerald-500 md:hover:bg-emerald-700 transition-colors rounded flex justify-center items-center">
                로그인
              </button>
            )}
          </div>
