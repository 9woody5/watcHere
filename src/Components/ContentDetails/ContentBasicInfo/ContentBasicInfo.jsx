...
function ContentBasicInfo(props) {
    ...
    return (
        <div className='w-full flex p-3' id="content-basic-info-box">
            <div className='w-2/5 flex flex-col items-center' id='poster-box'>
                <div className=''>
                    <img className='w-full object-cover' src={img}/>
                </div>
                <button
                    className='btn w-full mt-3 bg-white/10 hover:bg-white/20 text-white font-bold py-2 px-4 rounded-full'>예고편
                </button>
            </div>

            <div className='w-3/5 pl-3 text-white' id='basic-info-box'>
                ...
                <table className='table-fixed border-separate border-spacing-y-4 border-spacing-x-10 '
                       id="detail-info-list-box">
                    <tbody className=''>
                    <tr className='' id="score-box">
                        <th>평점</th>
                        <td><AiFillStar className='inline-block text-xl'/> {score}</td>
                    </tr>
                    <tr className='' id="score-box">
                        <th>개봉일자</th>
                        <td>{date}</td>
                ...
                <button
                    className='btn w-3/7 my-5 flex bg-amber-300 hover:bg-yellow-300 text-white font-bold p-3 rounded-full '>
